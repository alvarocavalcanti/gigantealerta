...
describe MarkersController do
  ...
  describe "GET show" do
    it "assigns the requested marker as @marker" do
      marker = Marker.create! valid_attributes
      get :show, {:id => marker.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested marker as @marker" do
      marker = Marker.create! valid_attributes
      get :edit, {:id => marker.to_param}, valid_session
      assigns(:marker).should eq(marker)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Marker" do
        expect {
          post :create, {:marker => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved marker as @marker" do
        ...
        post :create, {:marker => { "latitude" => "invalid value" }}, valid_session
        assigns(:marker).should be_a_new(Marker)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested marker" do
        ...
        Marker.any_instance.should_receive(:update_attributes).with({ "latitude" => "1.5" })
        put :update, {:id => marker.to_param, :marker => { "latitude" => "1.5" }}, valid_session
      end

      it "assigns the requested marker as @marker" do
        marker = Marker.create! valid_attributes
        put :update, {:id => marker.to_param, :marker => valid_attributes}, valid_session
        assigns(:marker).should eq(marker)
      end
    ...
    describe "with invalid params" do
      it "assigns the marker as @marker" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Marker.any_instance.stub(:save).and_return(false)
        put :update, {:id => marker.to_param, :marker => { "latitude" => "invalid value" }}, valid_session
        assigns(:marker).should eq(marker)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested marker" do
      marker = Marker.create! valid_attributes
      expect {
        delete :destroy, {:id => marker.to_param}, valid_session
      }.to change(Marker, :count).by(-1)
    end
